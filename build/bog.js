...
class Bog {
    ...
    render() {
        ...
        for (let i = 0; i < count; i++) {
            ...
            this.material1.uniforms.total.value = count;
            this.setQuadPosition(i, count);
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        bog = new Bog(size, size);
        yield bog.init();
        document.body.appendChild(bog.renderer.domElement);
    });
}
